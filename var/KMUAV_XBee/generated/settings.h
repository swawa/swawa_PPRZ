/* This file has been generated from /home/excelobs/paparazzi/var/KMUAV_XBee/settings_modules.xml /home/excelobs/paparazzi/conf/settings/basic.xml */
/* Please DO NOT EDIT */
...
#define DlSetting(_idx, _value) { \
  switch (_idx) { \
    ...
    case 10: infrared.roll_neutral = _value; break;\
    case 11: infrared.pitch_neutral = _value; break;\
    default: break;\
  }\
}
#define PeriodicSendDlValue(_chan) { \
  ...
  switch (i) { \
    ...
    case 10: var = infrared.roll_neutral; break;\
    case 11: var = infrared.pitch_neutral; break;\
    default: var = 0.; break;\
  }\
...
static inline float settings_get_value(uint8_t i) {
  switch (i) { \
    ...
    case 10: return infrared.roll_neutral;
    case 11: return infrared.pitch_neutral;
    default: return 0.;
    }
  }
