/* This file has been generated from /home/excelobs/paparazzi/conf/radios/cockpitMM.xml */
/* Please DO NOT EDIT */
...
#define NormalizePpmFIR(_ppm, _rc) {\
  ...
  int16_t tmp_radio;\
  tmp_radio = _ppm[RADIO_ROLL] - RC_PPM_TICS_OF_USEC(1498);\
  _rc.values[RADIO_ROLL] = tmp_radio * (tmp_radio >=0 ? (MAX_PPRZ/(float)(RC_PPM_SIGNED_TICS_OF_USEC(1000-1498))) : (MIN_PPRZ/(float)(RC_PPM_SIGNED_TICS_OF_USEC(2000-1498))));\
  Bound(_rc.values[RADIO_ROLL], MIN_PPRZ, MAX_PPRZ); \
\
  tmp_radio = _ppm[RADIO_PITCH] - RC_PPM_TICS_OF_USEC(1498);\
  _rc.values[RADIO_PITCH] = tmp_radio * (tmp_radio >=0 ? (MAX_PPRZ/(float)(RC_PPM_SIGNED_TICS_OF_USEC(1000-1498))) : (MIN_PPRZ/(float)(RC_PPM_SIGNED_TICS_OF_USEC(2000-1498))));\
  Bound(_rc.values[RADIO_PITCH], MIN_PPRZ, MAX_PPRZ); \
\
  tmp_radio = _ppm[RADIO_YAW] - RC_PPM_TICS_OF_USEC(1498);\
  _rc.values[RADIO_YAW] = tmp_radio * (tmp_radio >=0 ? (MAX_PPRZ/(float)(RC_PPM_SIGNED_TICS_OF_USEC(1000-1498))) : (MIN_PPRZ/(float)(RC_PPM_SIGNED_TICS_OF_USEC(2000-1498))));\
  Bound(_rc.values[RADIO_YAW], MIN_PPRZ, MAX_PPRZ); \
\
  tmp_radio = _ppm[RADIO_THROTTLE] - RC_PPM_TICS_OF_USEC(1120);\
  _rc.values[RADIO_THROTTLE] = tmp_radio * (MAX_PPRZ / (float)(RC_PPM_SIGNED_TICS_OF_USEC(2000-1120)));\
...
\
  ...
  if (avg_cpt == RC_AVG_PERIOD) {\
    avg_cpt = 0;\
    tmp_radio = _rc.avg_values[RADIO_GAIN1] / RC_AVG_PERIOD -  RC_PPM_TICS_OF_USEC(1498);\
    _rc.values[RADIO_GAIN1] = tmp_radio * (tmp_radio >=0 ? (MAX_PPRZ/(float)(RC_PPM_SIGNED_TICS_OF_USEC(1000-1498))) : (MIN_PPRZ/(float)(RC_PPM_SIGNED_TICS_OF_USEC(2000-1498))));\
...
\
    ...
    _rc.values[RADIO_MODE] = tmp_radio * (tmp_radio >=0 ? (MAX_PPRZ/(float)(RC_PPM_SIGNED_TICS_OF_USEC(1000-1500))) : (MIN_PPRZ/(float)(RC_PPM_SIGNED_TICS_OF_USEC(2000-1500))));\
    _rc.avg_values[RADIO_MODE] = 0;\
    Bound(_rc.values[RADIO_MODE], MIN_PPRZ, MAX_PPRZ); \
\
    tmp_radio = _rc.avg_values[RADIO_CALIB] / RC_AVG_PERIOD -  RC_PPM_TICS_OF_USEC(1500);\
    _rc.values[RADIO_CALIB] = tmp_radio * (tmp_radio >=0 ? (MAX_PPRZ/(float)(RC_PPM_SIGNED_TICS_OF_USEC(1000-1500))) : (MIN_PPRZ/(float)(RC_PPM_SIGNED_TICS_OF_USEC(2000-1500))));\
...
\
  tmp_radio = _ppm[RADIO_ROLL] - RC_PPM_TICS_OF_USEC(1498);\
  tmp_value = (tmp_radio >=0 ? (tmp_radio *  MAX_PPRZ) / (RC_PPM_SIGNED_TICS_OF_USEC(1000-1498)) : (tmp_radio * MIN_PPRZ) / (RC_PPM_SIGNED_TICS_OF_USEC(2000-1498)));\
...
\
  tmp_radio = _ppm[RADIO_THROTTLE] - RC_PPM_TICS_OF_USEC(1120);\
  tmp_value = (tmp_radio * MAX_PPRZ) / (RC_PPM_SIGNED_TICS_OF_USEC(2000-1120));\
  Bound(tmp_value, 0, MAX_PPRZ); \
  _rc.values[RADIO_THROTTLE] = (pprz_t)(tmp_value);\
\
  tmp_radio = _ppm[RADIO_GAIN1] - RC_PPM_TICS_OF_USEC(1498);\
  tmp_value = (tmp_radio >=0 ? (tmp_radio *  MAX_PPRZ) / (RC_PPM_SIGNED_TICS_OF_USEC(1000-1498)) : (tmp_radio * MIN_PPRZ) / (RC_PPM_SIGNED_TICS_OF_USEC(2000-1498)));\
  Bound(tmp_value, MIN_PPRZ, MAX_PPRZ); \
...
\
  ...
  tmp_value = (tmp_radio >=0 ? (tmp_radio *  MAX_PPRZ) / (RC_PPM_SIGNED_TICS_OF_USEC(1000-1500)) : (tmp_radio * MIN_PPRZ) / (RC_PPM_SIGNED_TICS_OF_USEC(2000-1500)));\
  Bound(tmp_value, MIN_PPRZ, MAX_PPRZ); \
  _rc.values[RADIO_MODE] = (pprz_t)((RADIO_FILTER * _rc.values[RADIO_MODE] + tmp_value) / (RADIO_FILTER + 1));\
\
  tmp_radio = _ppm[RADIO_CALIB] - RC_PPM_TICS_OF_USEC(1500);\
  tmp_value = (tmp_radio >=0 ? (tmp_radio *  MAX_PPRZ) / (RC_PPM_SIGNED_TICS_OF_USEC(1000-1500)) : (tmp_radio * MIN_PPRZ) / (RC_PPM_SIGNED_TICS_OF_USEC(2000-1500)));\
  Bound(tmp_value, MIN_PPRZ, MAX_PPRZ); \
