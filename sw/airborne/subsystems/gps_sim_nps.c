...
<html>
  <head>
    ...
    <script type="text/javascript">var NREUMQ=[];NREUMQ.push(["mark","firstbyte",new Date().getTime()]);</script>
        <title>sw/airborne/subsystems/gps/gps_sim_nps.c at master from paparazzi/paparazzi - GitHub</title>
  ...
  <link rel='canonical' href='/paparazzi/paparazzi/blob/8237283b4bc6380dee1591f872ca442a86bd52af/sw/airborne/subsystems/gps/gps_sim_nps.c'>
  ...
  <link href="https://github.com/paparazzi/paparazzi/commits/master.atom" rel="alternate" title="Recent Commits to paparazzi:master" type="application/atom+xml" />
    ...
    <script type="text/javascript">
      ...
      GitHub.currentPath = 'sw/airborne/subsystems/gps/gps_sim_nps.c';
  ...
  <body class="logged_out page-blob linux env-production">
    ...
    <ul class="nav logged_out">
      ...
      <li class="login"><a href="/login?return_to=%2Fpaparazzi%2Fpaparazzi%2Fblob%2Fmaster%2Fsw%2Fairborne%2Fsubsystems%2Fgps%2Fgps_sim_nps.c">Login</a></li>
    </ul>
  ...
  <ul>
    <li>
      ...
      <ul>
            ...
            <li><a href="/paparazzi/paparazzi/blob/HB/sw/airborne/subsystems/gps/gps_sim_nps.c" data-name="HB">HB</a></li>
          
        
          
          
            <li><a href="/paparazzi/paparazzi/blob/cam/sw/airborne/subsystems/gps/gps_sim_nps.c" data-name="cam">cam</a></li>
          
        
          
          
            <li><a href="/paparazzi/paparazzi/blob/campaign2010/sw/airborne/subsystems/gps/gps_sim_nps.c" data-name="campaign2010">campaign2010</a></li>
          
        
          
          
            <li><a href="/paparazzi/paparazzi/blob/dev/sw/airborne/subsystems/gps/gps_sim_nps.c" data-name="dev">dev</a></li>
            ...
            <li><a href="/paparazzi/paparazzi/blob/new-state-interface/sw/airborne/subsystems/gps/gps_sim_nps.c" data-name="new-state-interface">new-state-interface</a></li>
          
        
          
          
            <li><a href="/paparazzi/paparazzi/blob/pfd/sw/airborne/subsystems/gps/gps_sim_nps.c" data-name="pfd">pfd</a></li>
    ...
    <li>
      <a href="#" class="dropdown ">Switch Tags (2)</a>
              ...
              <li><a href="/paparazzi/paparazzi/blob/FwYapaXSens/sw/airborne/subsystems/gps/gps_sim_nps.c" data-name="FwYapaXSens">FwYapaXSens</a></li>
            
                      
              <li><a href="/paparazzi/paparazzi/blob/FwCHIMU/sw/airborne/subsystems/gps/gps_sim_nps.c" data-name="FwCHIMU">FwCHIMU</a></li>
  ...
  <input type="text" spellcheck="false" class="url-field" />
        <span style="display:none" id="clippy_2997" class="url-box-clippy"></span>
      <span id="clippy_tooltip_clippy_2997" class="clippy-tooltip tooltipped" title="copy to clipboard">
      ...
      <param NAME="FlashVars" value="id=clippy_2997&amp;copied=&amp;copyto=">
      ...
      <embed src="https://gs1.wac.edgecastcdn.net/80460E/assets/flash/clippy.swf?v5"
             ...
             FlashVars="id=clippy_2997&amp;copied=&amp;copyto="
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
...
<div class="flash-messages"></div>
  ...
  <div id="slider">
    ...
    <div class="breadcrumb" data-path="sw/airborne/subsystems/gps/gps_sim_nps.c/">
      ...
      <param name="quality" value="high" />
      <param name="scale" value="noscale" />
      <param NAME="FlashVars" value="id=clippy_3144&amp;copied=copied!&amp;copyto=copy to clipboard">
      <param name="bgcolor" value="#FFFFFF">
      <param name="wmode" value="opaque">
      <embed src="https://gs1.wac.edgecastcdn.net/80460E/assets/flash/clippy.swf?v5"
             width="110"
             ...
             type="application/x-shockwave-flash"
             pluginspage="http://www.macromedia.com/go/getflashplayer"
             FlashVars="id=clippy_3144&amp;copied=copied!&amp;copyto=copy to clipboard"
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
    ...
    <div class="frames">
      <div class="frame frame-center" data-path="sw/airborne/subsystems/gps/gps_sim_nps.c/" data-canonical-url="/paparazzi/paparazzi/blob/8237283b4bc6380dee1591f872ca442a86bd52af/sw/airborne/subsystems/gps/gps_sim_nps.c">
        
          <ul class="big-actions">
            
            <li><a class="file-edit-link minibutton" href="/paparazzi/paparazzi/edit/__current_ref__/sw/airborne/subsystems/gps/gps_sim_nps.c"><span>Edit this file</span></a></li>
          </ul>
        ...
        <div id="files">
          <div class="file">
            <div class="meta">
              ...
              <ul class="actions">
                <li><a href="/paparazzi/paparazzi/raw/master/sw/airborne/subsystems/gps/gps_sim_nps.c" id="raw-url">raw</a></li>
                
                  <li><a href="/paparazzi/paparazzi/blame/master/sw/airborne/subsystems/gps/gps_sim_nps.c">blame</a></li>
                
                <li><a href="/paparazzi/paparazzi/commits/master/sw/airborne/subsystems/gps/gps_sim_nps.c">history</a></li>
              </ul>
            </div>
...
<span id="L46" rel="#L46">46</span>
          ...
          <td width="100%">
                ...
                <div class="highlight"><pre><div class='line' id='LC1'><span class="cm">/*</span></div><div class='line' id='LC2'><span class="cm"> * Copyright (C) 2008-2011 The Paparazzi Team</span></div><div class='line' id='LC3'><span class="cm"> *</span></div><div class='line' id='LC4'><span class="cm"> * This file is part of paparazzi.</span></div><div class='line' id='LC5'><span class="cm"> *</span></div><div class='line' id='LC6'><span class="cm"> * paparazzi is free software; you can redistribute it and/or modify</span></div><div class='line' id='LC7'><span class="cm"> * it under the terms of the GNU General Public License as published by</span></div><div class='line' id='LC8'><span class="cm"> * the Free Software Foundation; either version 2, or (at your option)</span></div><div class='line' id='LC9'><span class="cm"> * any later version.</span></div><div class='line' id='LC10'><span class="cm"> *</span></div><div class='line' id='LC11'><span class="cm"> * paparazzi is distributed in the hope that it will be useful,</span></div><div class='line' id='LC12'><span class="cm"> * but WITHOUT ANY WARRANTY; without even the implied warranty of</span></div><div class='line' id='LC13'><span class="cm"> * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the</span></div><div class='line' id='LC14'><span class="cm"> * GNU General Public License for more details.</span></div><div class='line' id='LC15'><span class="cm"> *</span></div><div class='line' id='LC16'><span class="cm"> * You should have received a copy of the GNU General Public License</span></div><div class='line' id='LC17'><span class="cm"> * along with paparazzi; see the file COPYING.  If not, write to</span></div><div class='line' id='LC18'><span class="cm"> * the Free Software Foundation, 59 Temple Place - Suite 330,</span></div><div class='line' id='LC19'><span class="cm"> * Boston, MA 02111-1307, USA.</span></div><div class='line' id='LC20'><span class="cm"> */</span></div><div class='line' id='LC21'><br/></div><div class='line' id='LC22'><span class="cp">#include &quot;subsystems/gps/gps_sim_nps.h&quot;</span></div><div class='line' id='LC23'><span class="cp">#include &quot;subsystems/gps.h&quot;</span></div><div class='line' id='LC24'><br/></div><div class='line' id='LC25'><span class="n">bool_t</span> <span class="n">gps_available</span><span class="p">;</span></div><div class='line' id='LC26'><br/></div><div class='line' id='LC27'><span class="kt">void</span>  <span class="nf">gps_feed_value</span><span class="p">()</span> <span class="p">{</span></div><div class='line' id='LC28'>&nbsp;&nbsp;<span class="n">gps</span><span class="p">.</span><span class="n">ecef_pos</span><span class="p">.</span><span class="n">x</span> <span class="o">=</span> <span class="n">sensors</span><span class="p">.</span><span class="n">gps</span><span class="p">.</span><span class="n">ecef_pos</span><span class="p">.</span><span class="n">x</span> <span class="o">*</span> <span class="mf">100.</span><span class="p">;</span></div><div class='line' id='LC29'>&nbsp;&nbsp;<span class="n">gps</span><span class="p">.</span><span class="n">ecef_pos</span><span class="p">.</span><span class="n">y</span> <span class="o">=</span> <span class="n">sensors</span><span class="p">.</span><span class="n">gps</span><span class="p">.</span><span class="n">ecef_pos</span><span class="p">.</span><span class="n">y</span> <span class="o">*</span> <span class="mf">100.</span><span class="p">;</span></div><div class='line' id='LC30'>&nbsp;&nbsp;<span class="n">gps</span><span class="p">.</span><span class="n">ecef_pos</span><span class="p">.</span><span class="n">z</span> <span class="o">=</span> <span class="n">sensors</span><span class="p">.</span><span class="n">gps</span><span class="p">.</span><span class="n">ecef_pos</span><span class="p">.</span><span class="n">z</span> <span class="o">*</span> <span class="mf">100.</span><span class="p">;</span></div><div class='line' id='LC31'>&nbsp;&nbsp;<span class="n">gps</span><span class="p">.</span><span class="n">ecef_vel</span><span class="p">.</span><span class="n">x</span> <span class="o">=</span> <span class="n">sensors</span><span class="p">.</span><span class="n">gps</span><span class="p">.</span><span class="n">ecef_vel</span><span class="p">.</span><span class="n">x</span> <span class="o">*</span> <span class="mf">100.</span><span class="p">;</span></div><div class='line' id='LC32'>&nbsp;&nbsp;<span class="n">gps</span><span class="p">.</span><span class="n">ecef_vel</span><span class="p">.</span><span class="n">y</span> <span class="o">=</span> <span class="n">sensors</span><span class="p">.</span><span class="n">gps</span><span class="p">.</span><span class="n">ecef_vel</span><span class="p">.</span><span class="n">y</span> <span class="o">*</span> <span class="mf">100.</span><span class="p">;</span></div><div class='line' id='LC33'>&nbsp;&nbsp;<span class="n">gps</span><span class="p">.</span><span class="n">ecef_vel</span><span class="p">.</span><span class="n">z</span> <span class="o">=</span> <span class="n">sensors</span><span class="p">.</span><span class="n">gps</span><span class="p">.</span><span class="n">ecef_vel</span><span class="p">.</span><span class="n">z</span> <span class="o">*</span> <span class="mf">100.</span><span class="p">;</span></div><div class='line' id='LC34'>&nbsp;&nbsp;<span class="c1">//ecef pos seems to be based on geocentric model, hence we get a very high alt when converted to lla</span></div><div class='line' id='LC35'>&nbsp;&nbsp;<span class="n">gps</span><span class="p">.</span><span class="n">lla_pos</span><span class="p">.</span><span class="n">lat</span> <span class="o">=</span> <span class="n">sensors</span><span class="p">.</span><span class="n">gps</span><span class="p">.</span><span class="n">lla_pos</span><span class="p">.</span><span class="n">lat</span> <span class="o">*</span> <span class="mf">1e7</span><span class="p">;</span></div><div class='line' id='LC36'>&nbsp;&nbsp;<span class="n">gps</span><span class="p">.</span><span class="n">lla_pos</span><span class="p">.</span><span class="n">lon</span> <span class="o">=</span> <span class="n">sensors</span><span class="p">.</span><span class="n">gps</span><span class="p">.</span><span class="n">lla_pos</span><span class="p">.</span><span class="n">lon</span> <span class="o">*</span> <span class="mf">1e7</span><span class="p">;</span></div><div class='line' id='LC37'>&nbsp;&nbsp;<span class="n">gps</span><span class="p">.</span><span class="n">lla_pos</span><span class="p">.</span><span class="n">alt</span> <span class="o">=</span> <span class="n">sensors</span><span class="p">.</span><span class="n">gps</span><span class="p">.</span><span class="n">lla_pos</span><span class="p">.</span><span class="n">alt</span> <span class="o">*</span> <span class="mf">1000.</span><span class="p">;</span></div><div class='line' id='LC38'>&nbsp;&nbsp;<span class="n">gps</span><span class="p">.</span><span class="n">hmsl</span>        <span class="o">=</span> <span class="n">sensors</span><span class="p">.</span><span class="n">gps</span><span class="p">.</span><span class="n">hmsl</span> <span class="o">*</span> <span class="mf">1000.</span><span class="p">;</span></div><div class='line' id='LC39'>&nbsp;&nbsp;<span class="n">gps</span><span class="p">.</span><span class="n">fix</span> <span class="o">=</span> <span class="n">GPS_FIX_3D</span><span class="p">;</span></div><div class='line' id='LC40'>&nbsp;&nbsp;<span class="n">gps_available</span> <span class="o">=</span> <span class="n">TRUE</span><span class="p">;</span></div><div class='line' id='LC41'><span class="p">}</span></div><div class='line' id='LC42'><br/></div><div class='line' id='LC43'><span class="kt">void</span> <span class="nf">gps_impl_init</span><span class="p">()</span> <span class="p">{</span></div><div class='line' id='LC44'>&nbsp;&nbsp;<span class="n">gps_available</span> <span class="o">=</span> <span class="n">FALSE</span><span class="p">;</span></div><div class='line' id='LC45'><span class="p">}</span></div><div class='line' id='LC46'><br/></div></pre></div>
  ...
  <img src="https://gs1.wac.edgecastcdn.net/80460E/assets/images/modules/ajax/big_spinner_336699.gif" height="32" width="32">
    ...
    <div id="footer" class="clearfix">
      <div class="site">
        ...
        <ul class="sosueme">
          <li class="main">&copy; 2011 <span id="_rrt" title="0.38872s from fe5.rs.github.com">GitHub</span> Inc. All rights reserved.</li>
