...
<html>
  <head>
    ...
    <script type="text/javascript">var NREUMQ=[];NREUMQ.push(["mark","firstbyte",new Date().getTime()]);</script>
        <title>sw/airborne/subsystems/gps/gps_sim.h at master from paparazzi/paparazzi - GitHub</title>
  ...
  <link rel='canonical' href='/paparazzi/paparazzi/blob/8237283b4bc6380dee1591f872ca442a86bd52af/sw/airborne/subsystems/gps/gps_sim.h'>
  ...
  <link href="https://github.com/paparazzi/paparazzi/commits/master.atom" rel="alternate" title="Recent Commits to paparazzi:master" type="application/atom+xml" />
    ...
    <script type="text/javascript">
      ...
      GitHub.currentPath = 'sw/airborne/subsystems/gps/gps_sim.h';
  ...
  <body class="logged_out page-blob linux env-production">
    ...
    <ul class="nav logged_out">
      ...
      <li class="login"><a href="/login?return_to=%2Fpaparazzi%2Fpaparazzi%2Fblob%2Fmaster%2Fsw%2Fairborne%2Fsubsystems%2Fgps%2Fgps_sim.h">Login</a></li>
    </ul>
  ...
  <ul>
    <li>
      ...
      <ul>
            ...
            <li><a href="/paparazzi/paparazzi/blob/HB/sw/airborne/subsystems/gps/gps_sim.h" data-name="HB">HB</a></li>
          
        
          
          
            <li><a href="/paparazzi/paparazzi/blob/cam/sw/airborne/subsystems/gps/gps_sim.h" data-name="cam">cam</a></li>
          
        
          
          
            <li><a href="/paparazzi/paparazzi/blob/campaign2010/sw/airborne/subsystems/gps/gps_sim.h" data-name="campaign2010">campaign2010</a></li>
          
        
          
          
            <li><a href="/paparazzi/paparazzi/blob/dev/sw/airborne/subsystems/gps/gps_sim.h" data-name="dev">dev</a></li>
            ...
            <li><a href="/paparazzi/paparazzi/blob/new-state-interface/sw/airborne/subsystems/gps/gps_sim.h" data-name="new-state-interface">new-state-interface</a></li>
          
        
          
          
            <li><a href="/paparazzi/paparazzi/blob/pfd/sw/airborne/subsystems/gps/gps_sim.h" data-name="pfd">pfd</a></li>
    ...
    <li>
      <a href="#" class="dropdown ">Switch Tags (2)</a>
              ...
              <li><a href="/paparazzi/paparazzi/blob/FwYapaXSens/sw/airborne/subsystems/gps/gps_sim.h" data-name="FwYapaXSens">FwYapaXSens</a></li>
            
                      
              <li><a href="/paparazzi/paparazzi/blob/FwCHIMU/sw/airborne/subsystems/gps/gps_sim.h" data-name="FwCHIMU">FwCHIMU</a></li>
  ...
  <input type="text" spellcheck="false" class="url-field" />
        <span style="display:none" id="clippy_2958" class="url-box-clippy"></span>
      <span id="clippy_tooltip_clippy_2958" class="clippy-tooltip tooltipped" title="copy to clipboard">
      ...
      <param NAME="FlashVars" value="id=clippy_2958&amp;copied=&amp;copyto=">
      ...
      <embed src="https://gs1.wac.edgecastcdn.net/80460E/assets/flash/clippy.swf?v5"
             ...
             FlashVars="id=clippy_2958&amp;copied=&amp;copyto="
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
...
<div class="flash-messages"></div>
  ...
  <div id="slider">
    ...
    <div class="breadcrumb" data-path="sw/airborne/subsystems/gps/gps_sim.h/">
      ...
      <param name="quality" value="high" />
      <param name="scale" value="noscale" />
      <param NAME="FlashVars" value="id=clippy_1575&amp;copied=copied!&amp;copyto=copy to clipboard">
      <param name="bgcolor" value="#FFFFFF">
      <param name="wmode" value="opaque">
      <embed src="https://gs1.wac.edgecastcdn.net/80460E/assets/flash/clippy.swf?v5"
             width="110"
             ...
             type="application/x-shockwave-flash"
             pluginspage="http://www.macromedia.com/go/getflashplayer"
             FlashVars="id=clippy_1575&amp;copied=copied!&amp;copyto=copy to clipboard"
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
    ...
    <div class="frames">
      <div class="frame frame-center" data-path="sw/airborne/subsystems/gps/gps_sim.h/" data-canonical-url="/paparazzi/paparazzi/blob/8237283b4bc6380dee1591f872ca442a86bd52af/sw/airborne/subsystems/gps/gps_sim.h">
        
          <ul class="big-actions">
            
            <li><a class="file-edit-link minibutton" href="/paparazzi/paparazzi/edit/__current_ref__/sw/airborne/subsystems/gps/gps_sim.h"><span>Edit this file</span></a></li>
          </ul>
        ...
        <div id="files">
          <div class="file">
            <div class="meta">
              ...
              <ul class="actions">
                <li><a href="/paparazzi/paparazzi/raw/master/sw/airborne/subsystems/gps/gps_sim.h" id="raw-url">raw</a></li>
                
                  <li><a href="/paparazzi/paparazzi/blame/master/sw/airborne/subsystems/gps/gps_sim.h">blame</a></li>
                
                <li><a href="/paparazzi/paparazzi/commits/master/sw/airborne/subsystems/gps/gps_sim.h">history</a></li>
              </ul>
            </div>
...
<span id="L25" rel="#L25">25</span>
          ...
          <td width="100%">
                ...
                <div class="highlight"><pre><div class='line' id='LC1'><span class="cp">#ifndef GPS_SIM_H</span></div><div class='line' id='LC2'><span class="cp">#define GPS_SIM_H</span></div><div class='line' id='LC3'><br/></div><div class='line' id='LC4'><span class="cp">#include &quot;std.h&quot;</span></div><div class='line' id='LC5'><br/></div><div class='line' id='LC6'><span class="cp">#define GPS_NB_CHANNELS 16</span></div><div class='line' id='LC7'><br/></div><div class='line' id='LC8'><span class="k">extern</span> <span class="n">bool_t</span> <span class="n">gps_available</span><span class="p">;</span></div><div class='line' id='LC9'><br/></div><div class='line' id='LC10'><span class="c1">//extern void gps_feed_values(double utm_north, double utm_east, double utm_alt, double gspeed, double course, double climb);</span></div><div class='line' id='LC11'><br/></div><div class='line' id='LC12'><span class="k">extern</span> <span class="kt">void</span> <span class="n">gps_impl_init</span><span class="p">(</span><span class="kt">void</span><span class="p">);</span></div><div class='line' id='LC13'><br/></div><div class='line' id='LC14'><span class="cp">#define GpsEvent(_sol_available_callback) {     \</span></div><div class='line' id='LC15'><span class="cp">    if (gps_available) {                        \</span></div><div class='line' id='LC16'><span class="cp">      if (gps.fix == GPS_FIX_3D) {              \</span></div><div class='line' id='LC17'><span class="cp">        gps.last_fix_time = cpu_time_sec;       \</span></div><div class='line' id='LC18'><span class="cp">      }                                         \</span></div><div class='line' id='LC19'><span class="cp">      _sol_available_callback();                \</span></div><div class='line' id='LC20'><span class="cp">      gps_available = FALSE;                    \</span></div><div class='line' id='LC21'><span class="cp">    }                                           \</span></div><div class='line' id='LC22'><span class="cp">  }</span></div><div class='line' id='LC23'><br/></div><div class='line' id='LC24'><span class="cp">#endif </span><span class="cm">/* GPS_SIM_H */</span><span class="cp"></span></div><div class='line' id='LC25'><br/></div></pre></div>
  ...
  <img src="https://gs1.wac.edgecastcdn.net/80460E/assets/images/modules/ajax/big_spinner_336699.gif" height="32" width="32">
    ...
    <div id="footer" class="clearfix">
      <div class="site">
        ...
        <ul class="sosueme">
          <li class="main">&copy; 2011 <span id="_rrt" title="0.06860s from fe2.rs.github.com">GitHub</span> Inc. All rights reserved.</li>
