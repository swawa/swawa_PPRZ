...
<html>
  <head>
    ...
    <script>var NREUMQ=[];NREUMQ.push(["mark","firstbyte",new Date().getTime()]);</script>
        <title>sw/airborne/modules/sensors/AOA_adc.h at master from Bruzzlee/paparazzi - GitHub</title>
  ...
  <link rel='canonical' href='/Bruzzlee/paparazzi/blob/945f9d242905e19123d7821468936ab05859119d/sw/airborne/modules/sensors/AOA_adc.h'>
  ...
  <link href="https://github.com/Bruzzlee/paparazzi/commits/master.atom" rel="alternate" title="Recent Commits to paparazzi:master" type="application/atom+xml" />
    ...
    <script type="text/javascript">
      ...
      GitHub.currentPath = 'sw/airborne/modules/sensors/AOA_adc.h';
  ...
  <body class="logged_out page-blob  windows env-production">
    ...
    <ul class="nav logged_out">
      ...
      <li class="login"><a href="/login?return_to=%2FBruzzlee%2Fpaparazzi%2Fblob%2Fmaster%2Fsw%2Fairborne%2Fmodules%2Fsensors%2FAOA_adc.h">Login</a></li>
    </ul>
  ...
  <ul>
    <li>
      ...
      <ul>
            ...
            <li><a href="/Bruzzlee/paparazzi/blob/HB/sw/airborne/modules/sensors/AOA_adc.h" data-name="HB">HB</a></li>
          
        
          
          
            <li><a href="/Bruzzlee/paparazzi/blob/cam/sw/airborne/modules/sensors/AOA_adc.h" data-name="cam">cam</a></li>
          
        
          
          
            <li><a href="/Bruzzlee/paparazzi/blob/campaign2010/sw/airborne/modules/sensors/AOA_adc.h" data-name="campaign2010">campaign2010</a></li>
          
        
          
          
            <li><a href="/Bruzzlee/paparazzi/blob/dev/sw/airborne/modules/sensors/AOA_adc.h" data-name="dev">dev</a></li>
            ...
            <li><a href="/Bruzzlee/paparazzi/blob/new-state-interface/sw/airborne/modules/sensors/AOA_adc.h" data-name="new-state-interface">new-state-interface</a></li>
...
<div class="flash-messages"></div>
  ...
  <div id="slider">
    ...
    <div class="breadcrumb" data-path="sw/airborne/modules/sensors/AOA_adc.h/">
      ...
      <param name="quality" value="high" />
      <param name="scale" value="noscale" />
      <param NAME="FlashVars" value="id=clippy_228&amp;copied=copied!&amp;copyto=copy to clipboard">
      <param name="bgcolor" value="#FFFFFF">
      <param name="wmode" value="opaque">
      <embed src="https://d3nwyuy0nl342s.cloudfront.net/flash/clippy.swf?v5"
             width="110"
             ...
             type="application/x-shockwave-flash"
             pluginspage="http://www.macromedia.com/go/getflashplayer"
             FlashVars="id=clippy_228&amp;copied=copied!&amp;copyto=copy to clipboard"
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
    ...
    <div class="frames">
      <div class="frame frame-center" data-path="sw/airborne/modules/sensors/AOA_adc.h/" data-canonical-url="/Bruzzlee/paparazzi/blob/945f9d242905e19123d7821468936ab05859119d/sw/airborne/modules/sensors/AOA_adc.h">
        
          <ul class="big-actions">
            
            <li><a class="file-edit-link minibutton" href="/Bruzzlee/paparazzi/edit/__current_ref__/sw/airborne/modules/sensors/AOA_adc.h"><span>Edit this file</span></a></li>
          </ul>
        ...
        <div id="files">
          <div class="file">
            <div class="meta">
              ...
              <ul class="actions">
                <li><a href="/Bruzzlee/paparazzi/raw/master/sw/airborne/modules/sensors/AOA_adc.h" id="raw-url">raw</a></li>
                
                  <li><a href="/Bruzzlee/paparazzi/blame/master/sw/airborne/modules/sensors/AOA_adc.h">blame</a></li>
                
                <li><a href="/Bruzzlee/paparazzi/commits/master/sw/airborne/modules/sensors/AOA_adc.h">history</a></li>
              </ul>
            </div>
  ...
  <img src="https://d3nwyuy0nl342s.cloudfront.net/images/modules/ajax/big_spinner_336699.gif" height="32" width="32">
    ...
    <div id="footer" class="clearfix">
      <div class="site">
        ...
        <ul class="sosueme">
          <li class="main">&copy; 2011 <span id="_rrt" title="0.24058s from fe3.rs.github.com">GitHub</span> Inc. All rights reserved.</li>
...
`&lt;addr&gt;` element here instead.</pre>
    ...
    <script>(function(){var d=document;var e=d.createElement("script");e.async=true;e.src="https://d1ros97qkrwjf5.cloudfront.net/10/eum/rum.js	";var s=d.getElementsByTagName("script")[0];s.parentNode.insertBefore(e,s);})();NREUMQ.push(["nrf2","beacon-3.newrelic.com","2f94e4d8c2",64799,"dw1bEBZcX1RWRhoEClsAGhYFRA==",0,300,new Date().getTime()])</script>
  </body>
</html>
